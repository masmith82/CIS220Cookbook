...
-- Recipe 1: Spaghetti Aglio e Olio
    ...
    (1, 2, 2, 3, 'In a pan, sauté minced garlic in olive oil until golden.'),
    (1, 3, 3, 2, 'Add cooked spaghetti to the pan and toss. Serve with grated Parmesan.'),

-- Recipe 2: Chicken Caesar Salad
    (2, 1, 5, 1, 'Wash and chop Romaine lettuce.'),
    (2, 2, 6, 1, 'Grate Parmesan cheese.'),
    (2, 3, 4, 2, 'Grill chicken breast and slice into strips.'),
    (2, 4, 6, 25, 'Toss lettuce, chicken, and Parmesan. Add Caesar dressing.'),

-- Recipe 3: Vegetarian Stir Fry
    (3, 1, 7, 2, 'Slice bell pepper into strips.'),
    (3, 2, 8, 1, 'Season salmon fillet and bake in the oven.'),
    (3, 3, 9, 1, 'Cook penne pasta according to package instructions.'),
    (3, 4, 7, 1, 'Sauté bell pepper. Toss with cooked pasta and top with baked salmon.'),

-- Recipe 4: Grilled Cheese Sandwich
    (4, 1, 4, 2, 'Butter one side of each bread slice.'),
    (4, 2, 6, 1, 'Place Parmesan cheese between bread slices.'),
    (4, 3, 4, 2, 'Grill the sandwich until the bread is golden and the cheese is melted.'),

-- Recipe 5: Margherita Pizza
    (5, 1, 10, 3, 'Slice tomatoes into thin rounds.'),
    (5, 2, 6, 2, 'Slice fresh mozzarella.'),
    (5, 3, 2, 2, 'Roll out pizza dough. Add tomato slices and mozzarella. Bake until crust is golden.'),

-- Recipe 6: Omelette

    (6, 1, 8, 1, 'Season salmon fillet and bake in the oven.'),
    (6, 2, 1, 2, 'Whisk eggs and pour into a hot, greased pan.'),
    (6, 3, 8, 1, 'Flake baked salmon into the omelette. Fold and serve.'),

-- Recipe 7: Greek Salad

    (7, 1, 5, 1, 'Wash and chop Romaine lettuce.'),
    (7, 2, 6, 1, 'Grate Parmesan cheese.'),
    (7, 3, 10, 3, 'Slice tomatoes and olives. Toss with lettuce, cheese, and Greek dressing.'),

-- Recipe 8: Baked Salmon

    (8, 1, 8, 1, 'Season salmon fillet and bake in the oven until cooked through.'),

-- Recipe 9: Pasta Primavera

    (9, 1, 9, 1, 'Cook penne pasta according to package instructions.'),
    (9, 2, 7, 2, 'Slice bell pepper into strips and sauté with garlic.'),
    (9, 3, 10, 2, 'Dice tomatoes. Toss cooked pasta with vegetables.'),
